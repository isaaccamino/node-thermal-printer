class PrinterType {
  ...
  selectPrintColor(mode) {
    console.error(new Error("'selectPrintColor' not implemented yet"));
    return null;
  }
  ...
  async loadNVImages(loadNVImages) {
    console.error(new Error("'loadNVImage' not implemented yet"));
    return null;
  }

  generateNVImageBuffer(width, height, data) {
    console.error(new Error("'generateNVImageBuffer' not implemented yet"));
    return null;
  }

  printNVImage(num, mode) {
    console.error(new Error("'printNVImage' not implemented yet"));
    return null;
  }
