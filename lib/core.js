...
class ThermalPrinter {
  ...
  printStrikethrough = (units) => {
    ...
    {
      const printerMovementNumber = calculateTwoByteNumber((-UNIT_SIZE * units) - (UNIT_SIZE / 2));
    ...
    {
      const printerMovementNumber = calculateTwoByteNumber((UNIT_SIZE / 2) - (UNIT_SIZE * units));
      this.add(Buffer.from([0x1b, 0x5c, printerMovementNumber.nL, printerMovementNumber.nH]));
    }
